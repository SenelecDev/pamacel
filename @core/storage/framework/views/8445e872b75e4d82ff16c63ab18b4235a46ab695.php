<div class="single-events-list-item">
    ...
    <div class="content-area">
        ...
        <p><?php echo e(htmlspecialchars_decode(strip_tags(Str::words(strip_tags($event->content),20)))); ?></p>
    </div>
</div><?php /**PATH C:\laragon\www\pamacel\@core\resources\views/components/frontend/event/grid.blade.php ENDPATH**/ ?>